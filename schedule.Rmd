...
#### Mon, Sep 30
 * **In class**, we will work on:
    * Conditions for t and F based inference with the ANOVA model. [pdf](materials/20190930/anova_conditions.pdf)
 * **After class**, please:
 ...
 * **In class**, we will work on:
    * Transformations for ANOVA models.
        * Concepts: [pdf](materials/20190930/concepts_anova_transformations.pdf)
        * Examples with R code: [pdf](materials/20190930/example_anova_transformations.pdf)
...
#### Fri, Oct 04
 * **In class**, we will work on:
    * Alternative approaches to inference; reminder about permutation tests
 * **After class**, please:
")
```
