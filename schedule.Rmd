 ...
 * **In class**, we will work on:
    * Quiz
    * Diagnostics outliers and high leverage observations
    * Start on multiple regression: pairs plots, added variable plots
 * **After class**, please:
...
#### Fri, Nov 22
 * **In class**, we will work on:
    * Bootstrap Inference?  Or logistic regression?
 * **After class**, please:
")
```
