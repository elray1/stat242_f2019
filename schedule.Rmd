 ...
 * **In class**, we will work on:
    ...
    * More on F tests for ANOVA models.
        * slides illustrating how p-value calculations for F tests work: [pdf](materials/20190223_F/F_Test_p-values.pdf)
        * p-values for nested models: [pdf](materials/20190223_F/anova_F.pdf)
        * Finish Lab 3
 * **After class**, please:
