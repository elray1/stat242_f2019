 ...
 * **In class**, we will work on:
    ...
    * Think about conditions for the ANOVA model?  Or maybe multiple comparisons.
    * Possibly, start on data transformations for ANOVA
 * **After class**, please:
...
#### Mon, Sep 30
 * **In class**, we will work on:
    * Either alternative approaches to inference (reminder about permutation tests, start on bootstrap) or multiple comparisons
 * **After class**, please:


#### Wed, Oct 02
 * **In class**, we will work on:
    * More on bootstrap or more on multiple comparisons
 * **After class**, please:
