...
### Example: Handicaps and hiring (Sleuth3 Case Study 6.1.1 in Sleuth 3)
 ...
 * Suppose all 10 groups have the same mean: $\mu_1 = \mu_2 = \mu_3 = \mu_4 = \mu_5 = 5$ and standard deviation $\sigma = 1$.

 * In this setting, it's a mistake (Type I Error) to reject $H_0$ in any of the tests outlined above.
...
plot_df <- data.frame(
  x = rep(x_grid, 5),
  y = c(dnorm(x_grid, mean = 5, sd = group_sd),
        dnorm(x_grid, mean = 5, sd = group_sd),
        dnorm(x_grid, mean = 5, sd = group_sd),
        dnorm(x_grid, mean = 5, sd = group_sd),
        dnorm(x_grid, mean = 5, sd = group_sd)),
  group = rep(c("Group 1: mean = 5, sd = 1", "Group 2: mean = 5, sd = 1", "Group 3: mean = 5, sd = 1", "Group 4: mean = 5, sd = 1", "Group 5: mean = 5, sd = 1"),
    each = length(x_grid))
)
