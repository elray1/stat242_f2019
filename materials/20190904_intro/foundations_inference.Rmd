...
4. Type in the repository URL: https://github.com/mhc-stat242-f2019/Lab0.git
...
9. Click on the file named `Lab0_intro.Rmd` in the File browser pane on the lower right corner of the screen.
